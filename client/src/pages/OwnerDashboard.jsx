...
function getStyles(dark) {
  ...
  return {
    ...
    viewLink: { display: "inline-block", fontSize: "13px", color: ORANGE, fontWeight: "600", textDecoration: "none", marginBottom: "4px" },
    ...
    announcementCard: { backgroundColor: INNER_BG, borderRadius: "12px", padding: "16px", border: `1px solid ${CARD_BORDER}` },
