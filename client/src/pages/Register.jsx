...
function Register() {
  ...
  return (
    <div style={s.page}>
      {!isMobile && (
        <div style={s.left}>
          <h1 style={s.leftTitle}>🛖 Join Tindahan</h1>
          <p style={s.leftSub}>Be part of Tarlac City's growing local business community</p>
          <div style={s.roles}>
            <div style={s.roleCard}>
              <span style={s.roleEmoji}>🛍️</span>
              <div>
                <p style={s.roleTitle}>As a Customer</p>
                <p style={s.roleDesc}>Discover and review local businesses near you</p>
              </div>
            </div>
            <div style={s.roleCard}>
              <span style={s.roleEmoji}>🏪</span>
              <div>
                <p style={s.roleTitle}>As a Business Owner</p>
                <p style={s.roleDesc}>List your business and reach more customers</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={s.right}>
        ...
        <div style={s.card}>
          ...
          <p style={s.subtitle}>It's free and takes less than a minute</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={s.roleToggle}>
              <button
                type="button"
                style={form.role === "customer" ? s.roleActive : s.roleBtn}
              ...
              <button
                type="button"
                style={form.role === "owner" ? s.roleActive : s.roleBtn}
